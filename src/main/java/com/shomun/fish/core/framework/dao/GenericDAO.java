 ...
 */
package com.shomun.fish.core.framework.dao;
 ...
 *            to be used.
 */
public interface GenericDAO<T extends EntityBase, ID extends Serializable> {
	 ...
	 */
	public T find(ID id)throws HibernateException;

	/**
	 * Get all entities of the specified type from the datastore that have one
	 * of these ids.
	 */
	public T[] find(ID... ids)throws HibernateException;
	 ...
	 */
	public T getReference(ID id)throws HibernateException;
	 ...
	 *             found.
	 */
	public T[] getReferences(ID... ids)throws HibernateException;
	 ...
	 * instance already attached to the session, an error will be thrown.
	 */
	public boolean[] save(T... entities)throws HibernateException;
	 ...
	 */
	public void remove(T... entities)throws HibernateException;
	 ...
	 *         removed, <code>false</code> if it is not found.
	 */
	public boolean removeById(ID id)throws HibernateException;

	/**
	 * Remove all the entities of the given type from the datastore that have
	 * one of these ids.
	 */
	public void removeByIds(ID... ids)throws HibernateException;
